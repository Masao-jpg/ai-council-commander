...
このヒアリングを **スキップすることは絶対に禁止** です。十分な情報がないまま議論を進めることは、評議会の品質を著しく低下させます。
...
【ユーザーへの質問】
制約条件を明確化するためにユーザーに質問する必要がある場合は、必ず \`---USER_QUESTION---\` タグで囲んでください。タグなしの質問は検出されません。
...
【ユーザーへの質問】
論理的な整合性を確認するためにユーザーに質問する必要がある場合は、必ず \`---USER_QUESTION---\` タグで囲んでください。
...
【ユーザーへの質問】
ユーザーの価値観や好みを確認する必要がある場合は、必ず \`---USER_QUESTION---\` タグで囲んでください。
...
【ユーザーへの質問】
革新的なアイデアの方向性を確認するためにユーザーに質問する必要がある場合は、必ず \`---USER_QUESTION---\` タグで囲んでください。
...
【ユーザーへの質問】
リスクや改善点についてユーザーの判断を仰ぐ必要がある場合は、必ず \`---USER_QUESTION---\` タグで囲んでください。
